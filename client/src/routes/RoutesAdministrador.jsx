  ...
  return (
    <AdminTemplate>
      <Routes>
        ...
        <Route path="inventario/salasistemas" element={<Inventario seccion={1} title={"Sala de Sistemas #1"} />} />
        <Route path="inventario/salasistemas2" element={<Inventario seccion={2} title={"Sala de Sistemas #2"} />} />
        <Route path="inventario/salarobotica" element={<Inventario seccion={3} title={"Sala de Robotica"}/>} />
      </Routes>
    </AdminTemplate>
  );
}
